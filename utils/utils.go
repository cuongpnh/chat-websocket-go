...
func GetGooleOauthConfig() *oauth2.Config {
	return &oauth2.Config{
		...
		ClientID:     "491978716561-8jlo7n7mkpmdfi6mdrqe62a39b1gs9st.apps.googleusercontent.com", //os.Getenv("googlekey"),
		ClientSecret: "Nx2Qt89DjVqjZZc-IMnP2wPk",                                                 //os.Getenv("googlesecret"),
